...
class ApplicationsController extends AppController
{
    ...
    public function index()
    {
        ...
        $programs = $this->Applications->Programs->find('list', ['keyfield'=> 'id', 'valueField'=> function
        ($program){
           return $program->code . ' : ' . $program->name;
        }, 'limit' => 200])->all();
        $semesters = $this->Applications->Semesters->find('list', ['keyfield'=> 'id', 'valueField'=> function
        ($semester){
    ...
    public function view($id = null)
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            $application->ref_no = 'UiTM-' . $application->branch->code . '(HEA-' . $application->faculty->code . '.' .
            $application->program->code . '/' . $application->id . ''; //UiTM-branch_code(HEA-Faculty.Program/id)
