...
<nav id="sidebar" class="bg-body-tertiary shadow">
    <div class="sidebar-header pt-2 ps-3">
        <b class="gradient-animate-small"><b class="logo-small"><i class="fa-solid fa-check-double"></i></b> <?php echo $system_abbr; ?></b>
    </div>
    <div class="px-0">
        <ul class="list-unstyled components">
            ...
            ?>
                <li class="menu-item">
                    <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-house-flag"></i> Dashboard'), ['controller' => 'Dashboards', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>
            <?php }
            ?>
            <li class="menu-item">
            ...
            <?php if ($this->Identity->isLoggedIn()) { ?>
                ...
                <li class="menu-item <?= $c_name == 'Applications' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-regular fa-folder-open"></i> Applications'), ['controller' => 'Applications', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>
                ...
                <?php if ($this->Identity->isLoggedIn() && $this->Identity->get('user_group_id') == '1') { ?>
                    ...
                    <li class="menu-item <?= $c_name == 'Applications' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-folder-open"></i> Application <span class="badge text-bg-warning">'. $total_applications_pending .'</span>'), ['prefix' => 'Admin', 'controller' => 'Applications', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Faculties' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-school"></i> Faculty'), ['prefix' => 'Admin', 'controller' => 'Faculties', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Programs' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-chalkboard"></i> Program'), ['prefix' => 'Admin', 'controller' => 'Programs', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Branches' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-circle-notch"></i> Branch'), ['prefix' => 'Admin', 'controller' => 'Branches', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Semester' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-vector-square"></i> Semester'), ['prefix' => 'Admin', 'controller' => 'Semesters', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                <?php } ?>
            <?php } ?>
        </ul>
