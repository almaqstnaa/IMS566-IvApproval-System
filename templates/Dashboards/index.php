	...
	<div class="col-md-9 border-end">
		...
		<div class="d-none d-sm-block">
			<div class="activity-container">
				<div class="image-container img-one">
					<?= $this->Html->image('header/uitm.jpg', ['alt' => 'Code The Pixel']); ?>
					<div class="overlay">
						<h3><a href="https://istudent.uitm.edu.my/index_isp.htm"></a></h3>
					</div>
				</div>
				<div class="image-container img-two">
					<?= $this->Html->image('header/deloitte.jpg', ['alt' => 'Deloitte']); ?>
					<div class="overlay">
					</div>
				</div>
				<div class="image-container img-three">
					<?= $this->Html->image('header/map.png', ['alt' => 'map']); ?>
					<div class="overlay"></div>
				</div>
				<div class="image-container img-four">
					<?= $this->Html->image('header/petronas.jpg', ['alt' => 'petronas']); ?>
					<div class="overlay"></div>
				</div>
				<div class="image-container img-five">
					<?= $this->Html->image('header/interview.jpg', ['alt' => 'interview']); ?>
					<div class="overlay">
					</div>
				</div>
				<div class="image-container img-six">
					<?= $this->Html->image('header/uitmpurple.webp', ['alt' => 'uitmpurple']); ?>
					<div class="overlay">
					</div>
				</div>
			</div>
		...
		<div class="collapse show" id="chartCollapse">
			<div class="row mb-4">
				...
				<div class="col-md-3 ps-5">
					<div class="faq" data-waffly-title="Total Active FAQ" data-waffly-value="<?php echo 
					$approval_app_percent; ?>%">
