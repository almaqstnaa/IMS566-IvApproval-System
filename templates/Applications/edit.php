...
<div class="card rounded-0 mb-3 bg-body-tertiary border-0 shadow">
    <div class="card-body text-body-secondary">
        ...
        <fieldset>
            ...
            <div class="row">
                <div class="col-md-6"><?php echo $this->Form->control('pic_name', ['label' => 'Person In-charge 
                Name']); ?></div>
                <div class="col-md-6"><?php echo $this->Form->control('pic_email', ['label' => 'Person In-charge 
                Email']); ?></div>
            </div>

            <?php echo $this->Form->control('company_name', ['label' => 'Proposed Company Name']); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4"><?php echo $this->Form->control('company_state', [
                                            'options' => [
                                                ...
                                                'Sabah' => 'Sabah',
                                                'Sarawak' => 'Sarawak',
                                                'Wilayah Persekuatuan Kuala Lumpur' => 'Wilayah Persekutuan Kuala Lumpur',
